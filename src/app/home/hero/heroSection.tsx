export default function HeroSection() {
  return (
    <section className="hero-section relative h-screen flex items-start justify-start text-center overflow-hidden">
      {/* Background video */}
      <video
      ...
      {/* Content */}
      <div className="hero-content fixed flex flex-col text-left z-10 text-white px-4 w-[45vw] pt-25 mx-20">
